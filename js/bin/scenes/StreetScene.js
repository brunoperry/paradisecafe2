class StreetScene extends Scene {
  ...
  doThief() {
      ...
      if (this.thief.currentAction === Thief.Actions.ROB) {
        if (this.thief.isOutside) {
          ...
          if (Resources.PLAYER_INVENTORY.gun)
            this.balloon.doDialog([this.hero.getBalloon("dont_have_gun")]);
    ...
    switch (this.thief.currentAction) {
      ...
      case Thief.Actions.ROB:
        ...
        if (!Resources.PLAYER_INVENTORY.gun) {
          this.balloon.doDialog([this.thief.getBalloon("give_me_wallet")]);
          this.endAction = true;
          return;
        } else {
          this.balloon.doDialog([this.thief.getBalloon("give_me_wallet")], false);
        }
  ...
  doDarkAlley() {
    ...
    if (!Keyboard.isShown) {
      Keyboard.show([
        {
          text: Resources.labelsData.EXPLORE,
          action: Resources.labelsData.EXPLORE,
        },
        {
          text: Resources.labelsData.CONTINUE,
          action: Resources.labelsData.CONTINUE,
      ...
      Keyboard.onChange = (e) => {
        if (e === Resources.labelsData.EXPLORE) this.hero.doAction = true;
        this.endAction = true;
        Keyboard.hide();
      };
    }
